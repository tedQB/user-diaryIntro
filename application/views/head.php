...
<link rel="shortcut icon" href="http://www.jiese360.cn/favicon.ico" />
...
<style type="text/css">
	...
	*/
	.mui-bar-tab .mui-active .cate1{
	   background: url(http://kasia0001.hk155230.yhosts.biz/images/c1.jpg) no-repeat center center;	  	
	   background-size: 35px 22px; 
	}
	.mui-bar-tab .cate1{
	   background: url(http://kasia0001.hk155230.yhosts.biz/images/c2.jpg) no-repeat center center;	
	   background-size: 35px 22px; 	
	}	
	.mui-bar-tab .cate2{ background: url(http://kasia0001.hk155230.yhosts.biz/images/d1.jpg) no-repeat center center; background-size: 35px 22px; }
	.mui-bar-tab .mui-active .cate2{
	   background: url(http://kasia0001.hk155230.yhosts.biz/images/d2.jpg) no-repeat center center;	
	   background-size: 35px 22px; 	
	}
	.mui-bar-tab .cate3{ background: url(http://kasia0001.hk155230.yhosts.biz/images/a1.jpg) no-repeat center center; background-size: 35px 22px;  }
	.mui-bar-tab .mui-active .cate3{
	   background: url(http://kasia0001.hk155230.yhosts.biz/images/a2.jpg) no-repeat center center;	
	   background-size: 35px 22px; 	
	}
	.mui-bar-tab .cate4{ background: url(http://kasia0001.hk155230.yhosts.biz/images/c1.png) no-repeat center center;
	background-size: 35px 22px;  }
	.mui-bar-tab .mui-active .cate4{
	   background: url(http://kasia0001.hk155230.yhosts.biz/images/c2.png) no-repeat center center;	
	   background-size: 35px 22px; 	
	}
...
<body>
<img class="rich_media_thumb" height="0" width="0" src="http://mmbiz.qpic.cn/mmbiz/1kmH7bTs4t7YXfwtyIoGfN5Pm4CMMHic09059AjibicQcEQAeB6hUnsyicQSCSMo2A4rLZP5f9fmQhdIE1fTZdz1ZQ/0?tp=webp&amp;wxfrom=5">
